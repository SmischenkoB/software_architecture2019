...
public:
	...
	Controller* FindController(Type type);
	...
	virtual bool IsTypeOf(Type type) { return (type == Type::OBJECT) || UpdateList::IsTypeOf(type); }
...
public:
	...
	virtual Type GetType() { return Type::WORLDOBJECT; }
	virtual bool IsTypeOf(Type type) { return type == Type::WORLDOBJECT ||  Object::IsTypeOf(type); }
};
