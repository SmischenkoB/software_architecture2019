...
public:
	...
	void Draw(const Vector2D& pos, float size, float rotation = 0, unsigned long color = 0xffffffff, const Vector2D& topLeftUV = { 0, 0 }, const Vector2D& bottomRightUV = { 1, 1 });
	...
	// You can call this many times per frame (presumably with different parameters).
	void Draw(const Vector2D& pos, Vector2D size, float rotation = 0, unsigned long color = 0xffffffff, const Vector2D& topLeftUV = { 0, 0 }, const Vector2D& bottomRightUV = { 1, 1 });
